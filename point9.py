...
The outputs are: the value of sin(x) calcultaed by the compputer with the math module, 
the Maclaurin series approximation of sin(x), the difference between both previous values, 
